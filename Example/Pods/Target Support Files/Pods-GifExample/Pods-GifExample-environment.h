...
// CocoaGIF
#define COCOAPODS_POD_AVAILABLE_CocoaGIF
#define COCOAPODS_VERSION_MAJOR_CocoaGIF 0
#define COCOAPODS_VERSION_MINOR_CocoaGIF 0
#define COCOAPODS_VERSION_PATCH_CocoaGIF 1
